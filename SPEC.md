...
magro pede o quando em **3/3 nos dois modelos** (base 1/3) e as ancoradas ficam em **93%
contra 92% da base** — o ganho do LOTE-5 sem o preço do LOTE-5. `GENÉRICAS` 0/3 nos casos
...
`TracoTests/CicloDaMenteTests.swift`, `TracoTests/PoliticaTests.swift` e
`TracoTests/PerfilQualidadeTests.swift`; corridas inteiras em
