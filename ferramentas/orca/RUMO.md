...
| F6 | Widgets da tela bloqueada | accessoryCircular e accessoryInline do dia | **no branch `Vitorepf/volta-f6-bloqueada`** (ADR 09r): inline e retângulo fotografados na bloqueada de verdade pela primeira vez (a F1 errou: o editor existe, a captura é que é cega; a árvore de AX o dirige). Feito visível no inline, vazio que oferece nas duas faces, retângulo em duas linhas. **O círculo foi construído e retirado**: o feito não roda na bloqueada. |
