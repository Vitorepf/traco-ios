# Auditoria de superfície — 16/09/2026 noite (iPhone 17e, teclado de software)

Pedido do dono: "tem muitas coisas quebradas e de péssima qualidade". Auditor sem código, capturas em `auditoria-16-09-noite/NN-*.jpg`. Estado: [ ] aberto · [x] corrigido (commit) · [→] motor (executora).

## ALTA
- [x] Campo do pé encosta/entra no teclado (Notas 17–19, conversa 71–72, Marcar 41) — recuo −6 do Dock valia com teclado.
- [x] Decisão: último campo cresce atrás da barra "Fale com o Traço"; cursor escondido (34).
- [x] Conversa: abrir a fonte (obra) recolhe a resposta ("uma fonte mudou") (26→28).
- [x] Conversa: a obra abre no editor, crua e editável (27).
- [x] Conversa: rodapé "De …" com 3 URLs cruas do YouTube (24–25).
- [→] Conversa: diz que falta a decisão havendo 3; trata o dono por "você mesma" (24).
...
- [ ] Lente: "FRASES DE OUTRO", ícone de nuvem, divisórias desiguais (07). Três estilos de "Pronto" (07, 16, 43, 62).
- [ ] Notas: títulos com ponto final, prévias em minúscula, regra dos dois-pontos não aplicada em todas; rodapé com pesos diferentes; cabeçalhos 4 pt dentro; toque longo em "Hora de conferir" abre em vez de menu (12, 14, 68, 70).
- [ ] Compartilhar exporta tudo sem dizer (31).
- [ ] Conversa: "leu 1 obra" x 3 vídeos; "· obra" órfão; abrir fontes empurra ações para baixo do campo; placeholder muda 3 vezes; topo sem fundo ao rolar (21–28, 73).
- [ ] Decisão: sublinhado âmbar em campo sem foco (33).
- [ ] Calendário: grade do dia para em 23:00; faixas no gradiente da lista; linhas cortam cápsulas na semana; semana do ano em azul (36, 37, 39, 40).
- [ ] Padrões: aspas retas, ícone de lápis repetido, minúsculas (51, 52). Perfil: vãos de 80 pt entre seções recolhidas, divisórias desiguais (60, 65). Métodos: "Expressiva" sem seta (62).
