...
**Ferramentas.** `traco_contrato` (traz os métodos e a pergunta de cada um),
`traco_escrever` no fim.
...
2. Ache no contrato o método daquela forma e pegue **as perguntas dele**.
