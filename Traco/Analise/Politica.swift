...
enum Politica {
    ...
    static func linha(_ op: Operacao) -> Linha {
        ...
        case .instigar:
            .init(regra: .indisponivelPorQualidade,
                  ...
                  medidaEm: "10/09/2026",
                  conserto: "falta ela tirar as perguntas do que você escreveu, também quando cobra o quando")
        case .contrapor:
    ...
    static func semProvedor(_ op: Operacao) -> String {
        ...
        case .contrapor: "Contrapor pela IA está indisponível: ela ainda oferece a saída que você já tinha descartado. O Steelman e a Inversão continuam no catálogo, escritos por você."
